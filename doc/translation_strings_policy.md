...
This document provides guidelines for internationalization of the Matilda Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `matilda_en.ts` remains unchanged.

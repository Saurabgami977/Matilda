Matilda version 0.5.4 is now available for download at:
http://sourceforge.net/projects/matilda/files/Matilda/matilda-0.5.4/
...
http://gitorious.org/matilda/matildad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Matilda-Qt notifications under Growl 1.3.
Increase required age of Matilda-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMatilda properly when installing Matilda-Qt over it. (Windows)

Matilda Core version *0.15.2* is now available from:

  <https://matildacore.org/bin/matilda-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in matilda-tx (TheBlueMatt)

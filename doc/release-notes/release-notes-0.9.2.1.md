Matilda Core version 0.9.2.1 is now available from:

  https://matilda.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MTL to 0.01 MTL
...
- Fix "Start matilda on system login"

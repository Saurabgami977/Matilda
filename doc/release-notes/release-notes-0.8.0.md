Matilda-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/matilda/files/Matilda/matilda-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Matilda
...
New/changed settings (command-line or matilda.conf file)
--------------------------------------------------------

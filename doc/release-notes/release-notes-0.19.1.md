...
Matilda Core version 0.19.1 is now available from:

  <https://matildacore.org/bin/matilda-core-0.19.1/>
...
From Matilda Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Matilda Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Matilda Core does not yet change appearance when
...
- #17488 fix "matildad already running" warnings on macOS (fanquake)

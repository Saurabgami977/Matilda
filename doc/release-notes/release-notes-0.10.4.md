Matilda Core version 0.10.4 is now available from:

  <https://matilda.org/bin/matilda-core-0.10.4/>
...
- #6953 `43c2789` Split matilda-tx into its own package
- #6953 `dfe0d4d` Include matilda-tx binary on Debian/Ubuntu

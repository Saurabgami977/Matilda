Matilda Core version 0.13.2 is now available from:

  <https://matilda.org/bin/matilda-core-0.13.2/>
...
- #8908 `4a974b2` Update matilda-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow matilda-tx to create v2 transactions (MTLdrak)

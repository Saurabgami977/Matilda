Matilda Core version 0.9.4 is now available from:

  https://matilda.org/bin/0.9.4/
...
this update is incompatible with the Matilda system and could lead to consensus
forks.

Matilda Core released binaries from https://matilda.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~matilda/+archive/ubuntu/matilda
- A third-party or self-compiled Matilda Core

upgrade to Matilda Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

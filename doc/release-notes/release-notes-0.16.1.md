Matilda Core version 0.16.1 is now available from:

  <https://matildacore.org/bin/matilda-core-0.16.1/>
...
- #12843 `df38b13` Test starting matildad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure matildad processes are cleaned up when tests end (sdaftuar)

...
By default, matildad will dump mempool on shutdown and
...
class MempoolPersistTest(MatildaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent matildad from writing mempool.dat to disk. Verify that `savemempool` fails")

...
class TestShell:
    """Wrapper Class for MatildaTestFramework.

    The TestShell class extends the MatildaTestFramework
    ...
    class __TestShell(MatildaTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MatildaTestFramework child class.
            self.num_nodes = 1

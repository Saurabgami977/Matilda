...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MatildaTestFramework
    pass


class ExampleTest(MatildaTestFramework):
    # Each functional test is a subclass of the MatildaTestFramework class.
    ...
    def custom_method(self):
        ...
        MatildaTestFramework class so other tests can use it."""

...
class P2PPermissionsTests(MatildaTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].matildaconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].matildaconf, 'w', encoding="utf8") as f:
            f.write(newText)

...
"""Verify that starting matilda with -h works as expected."""

from test_framework.test_framework import MatildaTestFramework
from test_framework.util import assert_equal

class HelpTest(MatildaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start matilda with -h for help text")
        ...
        self.log.info("Start matilda with -version for version information")
        ...
        self.log.info("Start matildad with -fakearg to make sure it does not start")

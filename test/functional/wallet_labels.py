...
class WalletLabelsTest(MatildaTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Matildas
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid Matilda address or script",

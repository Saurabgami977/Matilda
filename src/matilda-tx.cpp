...
static void SetupMatildaTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " matilda-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  matilda-tx [options] <hex-tx> [commands]  Update hex-encoded matilda transaction\n" +
            "or:     matilda-tx [options] -create [commands]   Create hex-encoded matilda transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded matilda transaction

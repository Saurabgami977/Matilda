...
#ifndef MATILDA_INTERFACES_NODE_H
#define MATILDA_INTERFACES_NODE_H
...
//! Top-level interface for a matilda node (matildad process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MATILDA_INTERFACES_NODE_H

...
#ifndef MATILDA_COMPAT_ASSUMPTIONS_H
#define MATILDA_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Matilda cannot be compiled without assertions."
#endif
...
#endif // MATILDA_COMPAT_ASSUMPTIONS_H

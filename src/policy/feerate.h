...
#ifndef MATILDA_POLICY_FEERATE_H
#define MATILDA_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "MTL"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    MTL_KVB,      //!< Use MTL/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from MTL/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::MTL_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  MATILDA_POLICY_FEERATE_H

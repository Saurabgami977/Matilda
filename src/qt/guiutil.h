...
#ifndef MATILDA_QT_GUIUTIL_H
#define MATILDA_QT_GUIUTIL_H
...
/** Utility functions used by the Matilda Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "matilda:" URI into recipient object, return true on successful parsing

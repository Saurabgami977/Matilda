    ...
    mapper(nullptr)
{
    ...
    ui->matildaAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->matildaAtStartup);
    ...
    ui->matildaAtStartup->setToolTip(ui->matildaAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->matildaAtStartup->setText(ui->matildaAtStartup->text().arg(PACKAGE_NAME));

    ui->openMatildaConfButton->setToolTip(ui->openMatildaConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MatildaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->matildaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMatildaConfButton_clicked()
{

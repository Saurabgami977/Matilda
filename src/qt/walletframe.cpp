...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, MatildaGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &MatildaGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &MatildaGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &MatildaGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &MatildaGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &MatildaGUI::updateWalletStatus);
    connect(gui, &MatildaGUI::setPrivacy, walletView, &WalletView::setPrivacy);

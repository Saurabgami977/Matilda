    ...
    platformStyle(_platformStyle)
{
    ...
    // normal matilda address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying matilda address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MatildaAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

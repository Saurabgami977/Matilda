...
//! Entry point for MatildaApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MatildaApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MatildaGUI tests.
void AppTests::guiTests(MatildaGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MatildaGUI::consoleShown, this, &AppTests::consoleTests);

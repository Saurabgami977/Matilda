// Copyright (c) 2015-2018 The Matilda Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MATILDA_ZMQ_ZMQABSTRACTNOTIFIER_H
#define MATILDA_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // MATILDA_ZMQ_ZMQABSTRACTNOTIFIER_H

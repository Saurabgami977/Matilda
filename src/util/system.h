 ...
 */
#ifndef MATILDA_UTIL_SYSTEM_H
#define MATILDA_UTIL_SYSTEM_H
...
extern const char * const MATILDA_CONF_FILENAME;
extern const char * const MATILDA_SETTINGS_FILENAME;

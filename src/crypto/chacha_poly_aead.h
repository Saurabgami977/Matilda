...
#ifndef MATILDA_CRYPTO_CHACHA_POLY_AEAD_H
#define MATILDA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@matilda.
 *
 ...
 *
 * The chacha20-poly1305@matilda combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@matilda cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@matilda are relatively fast in
...
#endif // MATILDA_CRYPTO_CHACHA_POLY_AEAD_H

...
#ifndef MATILDA_TEST_SCRIPTNUM10_H
#define MATILDA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Matilda Core 0.10.0, for cross-comparison.
 */
public:

...
#ifndef MATILDA_WALLET_WALLETUTIL_H
#define MATILDA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! matilda from opening the wallet, thinking it was newly created, and
...
#endif // MATILDA_WALLET_WALLETUTIL_H

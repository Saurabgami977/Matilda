// Copyright (c) 2017-2018 The Matilda Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MATILDA_WALLET_COINSELECTION_H
#define MATILDA_WALLET_COINSELECTION_H
...
#endif // MATILDA_WALLET_COINSELECTION_H

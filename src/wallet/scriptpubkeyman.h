...
#ifndef MATILDA_WALLET_SCRIPTPUBKEYMAN_H
#define MATILDA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Matilda Core wallet was originally a collection of unrelated private
...
#endif // MATILDA_WALLET_SCRIPTPUBKEYMAN_H

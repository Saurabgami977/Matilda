...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Matilda
else
  DOCKER_EXEC echo \> \$HOME/.matilda
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/matilda/matilda/pull/18288#discussion_r433189350 for
  # details.

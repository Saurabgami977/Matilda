...
// matilda includes.
#include <..\src\script\matildaconsensus.h>
...
int main()
{
    std::cout << "matildaconsensus version: " << matildaconsensus_version() << std::endl;
    ...
    auto op0Result = matildaconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, matildaconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

...
# Deterministically build Matilda Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/matilda/' to
        #     '/home/satoshi/matilda/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/matilda
        #
        #                     maps our current working directory to /matilda
        ...
        #     container so that we have something to build. '/matilda' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /matilda && bash contrib/guix/libexec/build.sh"
    )

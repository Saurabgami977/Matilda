# Bootstrappable Matilda Core Builds

This directory contains the files necessary to perform bootstrappable Matilda
Core builds.
...
- 24GB of free disk space on the partition that the Matilda Core git repository
  resides in
...
For a Matilda Core depends development environment, simply invoke
...
From the top of a clean Matilda Core repository:
...
To use dongcarl's substitute server for Matilda Core builds after having

...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the matilda repository."
  exit 1
fi
...
# See https://github.com/matilda/matilda/issues/16064
...
echo 'When compiling matildad, run `./configure` in the following way:'
echo

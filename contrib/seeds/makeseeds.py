#!/usr/bin/env python3
# Copyright (c) 2013-2020 The Matilda Core developers
...
def main():
    ...
    # Filter out hosts with multiple matilda ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple matilda ports' % (ip_stats(ips)), file=sys.stderr)
